package com.awsblogs.smallfiles.sensors;
...
public class Accelerometer implements Serializable
{
    ...
    /*Accelerometer(int accelerometer_X, int accelerometer_Y, int accelerometer_Z,
                  int linearAccelerationSensor_X, int linearAccelerationSensor_Y, int linearAccelerationSensor_Z,
                  int gravitySensor_X, int gravitySensor_Y, int gravitySensor_Z)
    {
