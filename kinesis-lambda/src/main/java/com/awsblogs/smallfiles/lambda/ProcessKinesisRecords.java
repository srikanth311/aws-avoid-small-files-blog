package com.awsblogs.smallfiles.lambda;
...
import com.awsblogs.smallfiles.additionaldata.AdditionalIOTData;
import com.awsblogs.smallfiles.additionaldata.TestAdditonalData;
...
public class ProcessKinesisRecords implements RequestHandler<KinesisEvent, Void>{
    ...
    private ArrayList<TestAdditonalData> getAdditionalData()
    {
        ...
        for(int i =0;i <5000; i++)
        {
            ...
            t.setDimesnion_X(getRandomInt(10,1));
            t.setDimesnion_Y(getRandomInt(10,1));
            t.setDimesnion_Z(getRandomInt(10,1));
